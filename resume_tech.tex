...
\end{center}
  ...
  \resumeSentencesListStart
      ...
      \resumeSentences
      {Tech leader in data \& analytics. Left Google voluntarily in 2023 for a career sabbatical to pursue a personal interest in ecology by enrolling in a full-time graduate program. Now returning to the job market.}
...
\section{Experience}
    ...
    \resumeCompany{Google}{}{}
        ...
        \resumePosition
          ...
          \resumeItemListStart
            \resumeItem{Debugged issues in Google Ads bidding algorithms, conversion tracking, and ad targeting. Conducted A/B experiments. Collaborated with Product teams to inform feature development. Queried SQL databases. Earned \textbf{level promotion.}}
          \resumeItemListEnd

        \resumePosition
          {Optimization Specialist - gTech}{NYC, NY, USA}{2012–2014}
          \resumeItemListStart
            \resumeItem{Analyzed Google Ads Dynamic Remarketing campaigns performance (CTR, CPA, ROAS) for Sales teams and clients.}
          \resumeItemListEnd
...
\vspace{-15pt}\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Development \& BI Tools}{: Version Control (Git), Bug Tracking, SSH, IDEs, Data Visualization (Google Data Studio, Tableau), Cloud Data Warehousing (BigQuery), Jupyter Notebooks (Colab)} \\
